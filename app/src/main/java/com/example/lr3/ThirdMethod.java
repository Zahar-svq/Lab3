...
public class ThirdMethod extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AdapterView.OnItemClickListener itemListener = new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Toast.makeText(getApplicationContext(), "Вы выбрали " + selectedEmployee.getName(),
    ...
    {
        employees.add(new Employee("Петр", "Электрик",R.drawable.photo1));
        employees.add(new Employee("Михаил", "Сварщик",R.drawable.photo2));
        employees.add(new Employee("Леонид", "Кассир",R.drawable.photo3));
        employees.add(new Employee("Джамшут", "Программист",R.drawable.photo4));
    }
